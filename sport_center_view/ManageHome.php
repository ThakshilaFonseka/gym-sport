<?php include_once __DIR__ . '/ParentHeader.php'; ?>
    ...
    <section class="hero-section">
        <div class="hero-items owl-carousel">
            <div class="single-hero-item set-bg" data-setbg="../assets/img/hero-slider/hero-1.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero-text">
            ...
            <div class="single-hero-item set-bg" data-setbg="../assets/img/hero-slider/hero-2.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero-text">
            ...
            <div class="single-hero-item set-bg" data-setbg="../assets/img/hero-slider/hero-3.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero-text">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        <img src="../assets/img/icons/chose-icon-1.png" alt="">
                        <h5>Support 24/24</h5>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        <img src="../assets/img/icons/chose-icon-2.png" alt="">
                        <h5>Our trainer</h5>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        <img src="../assets/img/icons/chose-icon-3.png" alt="">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        <img src="../assets/img/icons/chose-icon-4.png" alt="">
                        <h5>Our equipment</h5>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        <img src="../assets/img/icons/chose-icon-5.png" alt="">
                        <h5>Classes daily</h5>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        <img src="../assets/img/icons/chose-icon-6.png" alt="">
        ...
        <div class="container">
            ...
            <div class="row blog-gird">
                ...
                <div class="col-lg-4 col-md-6 grid-item">
                    <div class="blog-item large-item set-bg" data-setbg="../assets/img/blog/blog-1.jpg">
                ...
                <div class="col-lg-4 col-md-6 grid-item">
                    <div class="blog-item small-item set-bg" data-setbg="../assets/img/blog/blog-2.jpg">
                        <a href="#" class="blog-text">
                            <div class="categories">Gym & Croosfit</div>
                ...
                <div class="col-lg-4 col-md-6 grid-item">
                    <div class="blog-item large-item xls-large set-bg" data-setbg="../assets/img/blog/blog-3.jpg">
                        <a href="#" class="blog-text">
                            <div class="categories">Gym & Croosfit</div>
                            <h5>Many people sign up for affiliate programs</h5>
                        </a>
                ...
                <div class="col-lg-4 col-md-6 grid-item">
                    <div class="blog-item large-item set-bg" data-setbg="../assets/img/blog/blog-4.jpg">
                        <a href="#" class="blog-text">
                            <div class="categories">Gym & Croosfit</div>
                            <h5>Many people sign up for affiliate programs</h5>
                        </a>
                ...
                <div class="col-lg-4 col-md-6 grid-item">
                    <div class="blog-item small-item set-bg" data-setbg="../assets/img/blog/blog-5.jpg">
                        <a href="#" class="blog-text">
                            <div class="categories">Gym & Croosfit</div>
